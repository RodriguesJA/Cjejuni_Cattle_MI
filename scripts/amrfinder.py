...
Genomes_file = open( "campy_ids.txt" ) #Text file with all the genomes to be used in this pipeline. File is used instead of a directory in order to easily edit which genomes are utilized
...
for i in Genomes_pair: #Here we are stripping tabs and spaces from file names 
	...
	os.system("amrfinder -n /"+RefGenome+".fasta -O Campylobacter --plus --name" + " " +RefGenome+" --nucleotide_output /amrfinderplus/"+RefGenome+"_amr.fasta -o campy_outputs/amrfinderplus/"+RefGenome+".tsv")
